...
namespace Exp
{
	...
	// -----------------------
	static void compileShader(std::string filename, std::string ext) {
		std::string command = "";
	...
	// ----------------------------------------------------------------------------------------------------------------------------------
	static void watchShaders(fs::path path) {
	...
	// --------------------------------------
	static void parseIniFile(std::ifstream& iniFile) {
	...
	// Program entry
	// -------------
	static void shaderWatcher(ftl::TaskScheduler* taskScheduler, void* arg) {
